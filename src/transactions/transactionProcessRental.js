...
export const transitions = {
  ...
  // When the provider finished the check-in-inspection transition from the
  // CheckInPage, it is transitioned with the check-in-inspection transition.
  CHECK_IN: 'transition/check-in-inspection',

  // When the provider finished the check-out-inspection transition from the
  // CheckOutPage, it is transitioned with the check-out-inspection transition.
  CHECK_OUT: 'transition/check-out-inspection',
...
export const graph = {
  ...
  id: 'adventshare-default-rent/2025-15-1',
  ...
  states: {
    ...
    [states.ACCEPTED]: {
      on: {
        ...
        [transitions.CHECK_IN]: states.CHECKED_IN,
    ...
    [states.CHECKED_IN]: {
      on: {
        [transitions.CHECK_OUT]: states.CHECKED_OUT,
      },
    },
...
export const isRelevantPastTransition = transition => {
  return [
    ...
    transitions.CANCEL,
    transitions.CHECK_OUT,
    transitions.CHECK_IN,
